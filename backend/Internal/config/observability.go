...
//func (c *ObservabilityConfig) NewRelicApp() (*newrelic.Application, error) {
//	config := newrelic.NewConfig(c.ServiceName, c.NewRelic.LicenseKey)
//	config.DistributedTracer.Enabled = c.NewRelic.DistributedTracingEnabled
//	config.AppLogForwarding.Enabled = c.NewRelic.AppLogForwardingEnabled
